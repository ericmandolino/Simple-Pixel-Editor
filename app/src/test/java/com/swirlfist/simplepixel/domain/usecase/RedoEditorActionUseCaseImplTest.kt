...
class RedoEditorActionUseCaseImplTest {

    private lateinit var useCase: RedoEditorActionUseCase
    ...
    @Before
    fun setup() {
        useCase = RedoEditorActionUseCaseImpl(pixelImageEditorActionRepository)
    }
